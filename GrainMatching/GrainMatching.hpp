...
int getopt(vector<string>& input, string& ref_name, string& comp_name, string& ref_aff, string& comp_aff, int& mode, int& minus, int& target_num_max, int& target_num_min) {
